...
$FW -A INPUT -i eth0 -p icmp --icmp-type 8 --src 192.168.0.0/16 -j ACCEPT # Ping
$FW -A INPUT -i eth0 -p tcp --src 192.168.0.0/16 --dport 22 -j ACCEPT # SSH
$FW -A INPUT -i eth0 -p udp --src 192.168.0.0/16 --dport 123 -j ACCEPT # NTP
$FW -A INPUT -j REJECT
